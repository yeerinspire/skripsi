...
<head>
  ...
  <!-- css -->
  <link href="poliklinik/css/bootstrap.min.css" rel="stylesheet" type="text/css">
  <link href="poliklinik/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
  <link rel="stylesheet" type="text/css" href="poliklinik/plugins/cubeportfolio/css/cubeportfolio.min.css">
  <link href="poliklinik/css/nivo-lightbox.css" rel="stylesheet" />
  <link href="poliklinik/css/nivo-lightbox-theme/default/default.css" rel="stylesheet" type="text/css" />
  <link href="poliklinik/css/owl.carousel.css" rel="stylesheet" media="screen" />
  <link href="poliklinik/css/owl.theme.css" rel="stylesheet" media="screen" />
  <link href="poliklinik/css/animate.css" rel="stylesheet" />
  <link href="poliklinik/css/style.css" rel="stylesheet">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
              ...
              <div class="well well-trans">
                <div class="wow fadeInRight" data-wow-delay="0.1s">
                  ...
                  <p class="text-right wow bounceIn" data-wow-delay="0.4s">
                    <a href="login.php" class="btn btn-skin btn-lg">Login Admin <i class="fa fa-angle-right"></i></a>
                  </p>
                </div>
              </div>
  ...
  <script src="poliklinik/js/jquery.min.js"></script>
  <script src="poliklinik/js/bootstrap.min.js"></script>
  <script src="poliklinik/js/jquery.easing.min.js"></script>
  <script src="poliklinik/js/wow.min.js"></script>
  <script src="poliklinik/js/jquery.scrollTo.js"></script>
  <script src="poliklinik/js/jquery.appear.js"></script>
  <script src="poliklinik/js/stellar.js"></script>
  <script src="poliklinik/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
  <script src="poliklinik/js/owl.carousel.min.js"></script>
  <script src="poliklinik/js/nivo-lightbox.min.js"></script>
  <script src="poliklinik/js/custom.js"></script>
